...
1. **Anchoring Effect**: We rely too heavily on the first piece of information
2. **Availability Heuristic**: We overestimate the likelihood of events we can easily recall
3. **Confirmation Bias**: We seek information that confirms our existing beliefs
4. **Loss Aversion**: Losses loom larger than equivalent gains
